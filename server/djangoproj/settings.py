...
ALLOWED_HOSTS = ['localhost',
                 'https://ahmadfauzir-8000.theianext-0-labs-prod-misc-'
                 'tools-us-east-0.proxy.cognitiveclass.ai']
CSRF_TRUSTED_ORIGINS = ['https://ahmadfauzir-8000.theianext-0-labs-prod-'
                        'misc-tools-us-east-0.proxy.cognitiveclass.ai',
                        'https://ahmadfauzir-8000.theiadockernext-1-labs-'
