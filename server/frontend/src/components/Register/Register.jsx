...
const Register = () => {
  ...
  const register = async (e) => {
    ...
    if (json.status) {
      ...
      alert("Oops! The username is used. Please try other username.");
    }
  };
  ...
  return (
    <div className="register_container">
      ...
      {/* Bagian Header Form - Menggunakan class .header dari CSS */}
      ...
      <form onSubmit={register}>
        {/* Kontainer seluruh input - Menggunakan class .inputs */}
        <div className="inputs">
          
          {/* SINKRONISASI: Mengubah className menjadi 'input_field' agar desain kotaknya aktif */}
          <div className="input">
        ...
        {/* Panel Tombol - Menggunakan class .submit_panel dan .submit */}
